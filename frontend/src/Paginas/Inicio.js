    ...
    <div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3" >
      <div class=" mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden" style={{background:'#C0C0C0'}}>
        <div class="my-3 p-3">
          ...
          <p class="lead">Adentrate a la aventura con nuestro tiquete oro, este tiquete solo es válido para una persona, diviertete explorando las atracciones familiares e infantiles. $50 </p>
